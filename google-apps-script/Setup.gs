function setupMinettiFutbol() {
  ...
  var sheets = {
    ...
    Usuarios: ['id','username','email','password','role','name','firstName','lastName','dni','teamId','teamName','status'],
    Solicitudes_Registro: ['id','userId','firstName','lastName','dni','email','whatsapp','teamName','tempPassword','status','createdAt'],
