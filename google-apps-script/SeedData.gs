function seedMinettiFutbol() {
  seedRows_('Config', [
    ['Torneo Municipal de Fútbol de Menores 2026','Municipalidad Distrital de Pachacamac','Estadio Sector B – Huertos de Manchay','2026','Fase de grupos']
  ]);
  ...
  seedRows_('Usuarios', [
    ...
    ['U002','guerreros','demo123','entrenador','Delegado Guerreros','EQ-S6-003','activo']
  ]);
  seedRows_('Equipos', [
    ['EQ-S6-001','JM SPORT','SUB6','Único'],
    ['EQ-S6-002','TOLENTINO FC','SUB6','Único'],
    ['EQ-S6-003','GUERREROS DE MANCHAY','SUB6','Único'],
    ['EQ-S6-004','CLUB DEPORTIVO LARA','SUB6','Único'],
    ['EQ-S6-005','RENACE JUVENTUD','SUB6','Único'],
    ['EQ-S6-006','BENJAMIN FC','SUB6','Único']
  ]);
  seedRows_('Jugadores', [
    ['P001','EQ-S6-003','GUERREROS DE MANCHAY','SUB6','Jugador','Demo 1','90000001','2020-04-15','90000001.png','aprobado', new Date()],
    ['P002','EQ-S6-003','GUERREROS DE MANCHAY','SUB6','Jugador','Demo 2','90000002','2020-07-08','90000002.png','aprobado', new Date()]
  ]);
  seedRows_('Fixture', [
    ...
    ['M033',3,'Fecha 03','Por programar','--:--','GUERREROS DE MANCHAY','JM SPORT','SUB6','Único','pendiente','','', '']
  ]);
}
